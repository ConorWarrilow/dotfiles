      ...
      buftype = {
        nofile = {
          ...
          code = {
            ...
            -- Remove or change these to highlights without backgrounds
            highlight_language = 'NormalFloat', -- Use NormalFloat instead
            highlight_info = 'NormalFloat', -- Use NormalFloat instead
            highlight_inline = 'NormalFloat', -- Use NormalFloat instead
            highlight_fallback = 'NormalFloat', -- Use NormalFloat instead
            border = 'none',
            language_name = false, -- This will hide the language name completely
            language_icon = false, -- This will hide the language icon
          },
        },
      },
